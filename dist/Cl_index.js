...
export default class Cl_index {
    constructor() {
        ...
        window.cargarDatosPrueba = () => this.cargarDatosPrueba();
    }
    ...
    cargarDatosPrueba() {
        return __awaiter(this, void 0, void 0, function* () {
            ...
            try {
                ...
                const hayDatos = yield this.verificarSiHayDatos();
                if (hayDatos) {
                    ...
                    yield this.limpiarTodosDatos();
                    // Esperar a que se complete la limpieza
                    yield new Promise(resolve => setTimeout(resolve, 2000));
                }
                // Cargar datos de prueba
                yield this.cargarDatosPruebaCompleta();
